...
class ItemServiceImplTest {
    ...
    @Test
    void createItem_WithRequestId_LinksRequestToItem() {
        ItemRequest itemRequest = new ItemRequest(5L, "Need a drill", user, java.time.LocalDateTime.now());
        itemDto.setRequestId(5L);
        Item savedItem = new Item(1L, "Test Item", "Test Description", true, user, itemRequest);
